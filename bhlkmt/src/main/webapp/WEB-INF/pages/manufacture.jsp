...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<template:template_page title="Nhà Sản Xuất">
		                ...
		                <section class="tile">
		                    ...
		                    <div class="tile-header dvd dvd-btm">
		                        <h1 class="custom-font">
											<strong>Danh Sách Nhà Sản Xuất</strong> </h1>
		                        <ul class="controls">
		                            <li>
		                        ...
		                        <form class="form-horizontal" role="form"
	                                ...
	                                <div class="form-group">
	                                    <div id="action"
	                                        ...
	                                        <button id="btnSubmit"
												type="submit" id="CreateFormSubmit" value="Create"
	...
	<jsp:attribute name="javascript_area">
	    ...
	    <script type="text/javascript"
			src="resources/js/custom/manufacture.js"></script>
	</jsp:attribute>
